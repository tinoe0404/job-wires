        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-gray-400 text-lg leading-relaxed">
              For over 15 years, Joshwires has been at the forefront of delivering
              premium wire mesh and fencing solutions across Zimbabwe.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            >
              ...
              <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl p-5 shadow-xl border border-gray-100">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-gradient-to-br from-lime to-lime-light rounded-xl flex items-center justify-center">
              ...
              <div className="absolute -top-4 -left-4 w-24 h-24 bg-lime/10 rounded-2xl -z-10" />
            </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                whileInView="visible"
                viewport={{ once: true }}
                className="group bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl border border-gray-100 hover:border-lime/20 transition-all duration-500 text-center"
              >
                <div
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="group flex gap-5 bg-gray-50 rounded-2xl p-6 hover:bg-white hover:shadow-xl hover:shadow-lime/5 border border-transparent hover:border-lime/20 transition-all duration-500"
              >
                <div className="w-12 h-12 bg-gradient-to-br from-lime/20 to-lime-light/10 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
